...
namespace TajHotel.web.Areas.Foods.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderName,Quantity,Deliverydate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderName,Quantity,Deliverydate")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
